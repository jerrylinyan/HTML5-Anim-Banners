...
(function (){
  ...
  function generateFrame0(tl){
    ...
    tl.add(TweenLite.to(".background-1", 2.5, {scale:.65, x:6, y:160, ease:"none"}), "startf0+=.5");
    tl.add(TweenLite.to(".fraxel", 2.3, {scale: 1, autoAlpha: 1, x:30, y:160, ease:"none"}), "startf0+=.6");
    tl.add(TweenLite.to(".headline-1", 1, {autoAlpha:1, ease:Strong.easeInOut}), "startf0+=3");
    tl.add(TweenLite.to(".tandc", 1, {autoAlpha:1, ease:Strong.easeInOut}), "startf0+=3.5");
    tl.add(TweenLite.to(".headline-1", 1, {autoAlpha:0, ease:Strong.easeInOut}), "startf0+=6");
    tl.add(TweenLite.to(".tandc", 1, {autoAlpha:0, ease:Strong.easeInOut}), "startf0+=6");
    tl.add(TweenLite.to(".background-2", 1, {autoAlpha:1, ease:Strong.easeInOut}), "startf0+=6");
    tl.add(TweenLite.to(".headline-2", 1, {autoAlpha:1, ease:Strong.easeInOut}), "startf0+=6.5");
