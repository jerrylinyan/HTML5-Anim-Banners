...
(function (){
  ...
  function generateFrame0(tl){
    ...
    tl.add(TweenLite.to(".background-1", 3, {scale:.8, x:122, y:5, ease:Strong.ease}), "startf0");
    tl.add(TweenLite.to(".fraxel", 1.3, {scale: 1, autoAlpha: 1, x:300, y:160, ease:Strong.easeInOut}), "startf0+=.5");
