...
(function (){
  ...
  function generateFrame0(tl){
    ...
    tl.add(TweenLite.to(".background-1", 2.5, {scale:.8, x:6, y:100, ease:"none"}), "startf0+=.5");
    tl.add(TweenLite.to(".fraxel", 2.3, {scale: 1, autoAlpha: 1, y:160, ease:"none"}), "startf0+=.6");
