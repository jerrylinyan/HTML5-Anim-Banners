...
(function (){
  ...
  function generateFrame0(tl){
    ...
    tl.add(TweenLite.to(".headline-1", 1, {autoAlpha:1, ease:Strong.easeInOut}), "startf0+=.5");
    tl.add(TweenLite.to(".tandc", 1, {autoAlpha:1, ease:Strong.easeInOut}), "startf0+=.8");
    tl.add(TweenLite.to(".headline-1", 1, {autoAlpha:0, ease:Strong.easeInOut}), "startf0+=3.5");
    tl.add(TweenLite.to(".tandc", 1, {autoAlpha:0, ease:Strong.easeInOut}), "startf0+=3.5");
    tl.add(TweenLite.to(".headline-2", 1, {autoAlpha:1, ease:Strong.easeInOut}), "startf0+=4.5");
    tl.add(TweenLite.to(".cta-group, .cta-group .cta", 1, {opacity:1, ease:Strong.easeInOut, onComplete: addShine}), "startf0+=4.5");
