...
(function (){
  ...
  function generateFrame0(tl){
    ...
    tl.add(TweenLite.to(".background", 1, {width: 970, ease:Strong.easeInOut}), "startf0+=4");
    tl.add(TweenLite.fromTo("#bgFixed", 1, {drawSVG:1, ease:Strong.easeInOut}, {drawSVG:"100%", ease:Strong.easeInOut}), "startf0+=4.5");
    tl.add(TweenLite.to("#maskerOrange", 1, {duration: 1, attr: { x: 0 }, ease: Strong.easeInOut, onUpdate:slideFillIn}), "startf0+=5.5");
    tl.add(TweenLite.to("#startColor text", 1, {autoAlpha:1, ease:Strong.easeInOut}), "startf0+=5.5");
    tl.add(TweenLite.to("#maskerWhite", 1, {  yoyo: true, repeat: 1, repeatDelay: .3, duration: 1, attr: { x: 0 }, ease: Strong.easeInOut, onUpdate:slideFillIn}), "startf0+=6.5");
